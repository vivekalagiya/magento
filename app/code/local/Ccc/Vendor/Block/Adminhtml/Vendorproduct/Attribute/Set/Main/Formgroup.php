...
class Ccc_Attribute_Block_Vendorproduct_Adminhtml_Attribute_Set_Main_Formgroup extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setMethod('post');
        $form->setAction($this->getUrl('*/vendorproduct_group/save'));
        $this->setForm($form);
    }
