...
class Ccc_Vendor_Block_Adminhtml_Vendorproduct_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('group_tree',
            $this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute_set_main_tree_group')
        );

        $this->setChild('edit_set_form',
            $this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute_set_main_formset')
        );
    ...
    {
        return $this->getUrl('*/vendorproduct_set/save', array('id' => $this->_getSetId()));
    }

    public function getGroupUrl()
    {
        return $this->getUrl('*/vendorproduct_group/save', array('id' => $this->_getSetId()));
    }
