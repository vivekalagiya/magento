...
$table = $installer->getConnection()
    ->newTable($installer->getTable('vendor/eav_productattribute'))
    ...
    ->addIndex($installer->getIdxName('vendor/eav_productattribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('vendor/eav_productattribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('vendor/eav_productattribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
...
$setup->addAttribute(Ccc_Vendor_Model_Resource_Product::ENTITY, 'name', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'name',
...
$setup->addAttribute(Ccc_Vendor_Model_Resource_Product::ENTITY, 'price', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'price',
...
$setup->addAttribute(Ccc_Vendor_Model_Resource_Product::ENTITY, 'quantity', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'int',
    'label'                      => 'quantity',
