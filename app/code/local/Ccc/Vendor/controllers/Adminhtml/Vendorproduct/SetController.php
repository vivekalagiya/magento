...
class Ccc_Vendor_Adminhtml_Vendorproduct_setController extends Mage_Adminhtml_Controller_Action
{
	...
	public function indexAction()
	{
        ...
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute_set_toolbar_main'));
      
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute_set_grid'));
	...
	public function addAction()
    {
        ...
        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute_set_toolbar_add'));
    ...
    public function editAction()
    {
        ...
        $this->_addBreadcrumb(Mage::helper('vendor')->__('vendor'), Mage::helper('vendor')->__('vendor product'));
        $this->_addBreadcrumb(
            Mage::helper('vendor')->__('Manage Vendor Product Attribute Sets'),
            Mage::helper('vendor')->__('Manage Vendor Product Attribute Sets'));

        $this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute_set_main'));
