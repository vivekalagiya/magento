...
class Ccc_Vendor_Adminhtml_Vendorproduct_AttributeController extends Mage_Adminhtml_Controller_Action
{
	...
	public function indexAction()
	{
		...
		$this->_addContent($this->getLayout()->createBlock('vendor/adminhtml_vendorproduct_attribute'));
    ...
    {	
        ...
        $item = $id ? Mage::helper('vendor')->__('Edit Vendor Product Attribute')
                    : Mage::helper('vendor')->__('New Vendor Product Attribute');
