...
class Ccc_Browse_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    ...
    const ENTITY                                = 'browse_eav_attribute';
    ...
    //         $attributes = Mage::getResourceSingleton('browseattribute/browseattribute')->getAttributesByCode();
